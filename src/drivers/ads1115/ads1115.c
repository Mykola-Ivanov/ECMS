...
/** 
 * @brief Interrupt handler for the GPIO pin used by the ADS1115
 * 
 * This function is called when the GPIO pin configured for the ADS1115
 * ready signal is triggered. It sends a dummy value to the queue to indicate
...
/**
 * @brief Write a value to a specific register of the ADS1115
 * 
...
/**
 * @brief Read a register from the ADS1115
 * 
 * @param ads Pointer to the ADS1115 configuration structure
...
/**
 * @brief Initialize the ADS1115 configuration with default values
 * 
 * @param i2c_port The I2C port to be used for communication
 * @param address The I2C address of the ADS1115 device
 * @return ads1115_t Initialized ADS1115 configuration structure
 */
...
/**
 * @brief Set the multiplexer for the ADS1115
 * 
 * @param ads Pointer to the ADS1115 configuration structure
 * @param mux Multiplexer setting to be applied
 */
...
/**
 * @brief Set the ready pin for the ADS1115
 * 
 * @param ads Pointer to the ADS1115 configuration structure
 * @param gpio GPIO number to be used as the ready pin
 */
...
/**
 * @brief Set the programmable gain amplifier (PGA) for the ADS1115
 * 
 * @param ads Pointer to the ADS1115 configuration structure
 * @param fsr Full-scale range setting to be applied
 */
...
/**
 * @brief Set the mode of operation for the ADS1115
 * 
 * @param ads Pointer to the ADS1115 configuration structure
 * @param mode Mode to be set (continuous or single)
 */
...
/**
 * @brief Set the samples per second (SPS) for the ADS1115
 * 
 * @param ads Pointer to the ADS1115 configuration structure
 * @param sps Samples per second setting to be applied
 */
...
/**
 * @brief Set the maximum wait ticks for I2C communication
 * 
 * @param ads Pointer to the ADS1115 configuration structure
 * @param max_ticks Maximum ticks to wait for I2C operations
 */
...
int16_t ads1115_get_raw(ads1115_t* ads) {
  ...
  if((ads->config.bit.MODE==(uint16_t)ADS1115_MODE_SINGLE) || (ads->changed)) {               // if it's single-ended or a setting changed
...
/**
 * @brief Get the voltage reading from the ADS1115
 * 
 * This function reads the raw ADC value and converts it to a voltage based on the
 * configured full-scale range (FSR) of the ADS1115.
 * 
 * @param ads Pointer to the ADS1115 configuration structure
